// ==UserScript==
// @name        RAA subaccount UDOIT reports download
// @author      WenChen Hol
...
(function () {
  ...
  var termsAr = [ "1" ]; //only default term
  ...
  var actionsAr = [];
  var coursesAr = [];
  //https://apac.udoit3.ciditools.com/api/admin/courses/account/165/term/253?subaccounts=true
  var urlAr = [ 
  'https://apac.udoit3.ciditools.com/api/admin/reports/account/165/term/{termId}?subaccounts=true',
  'https://apac.udoit3.ciditools.com/api/admin/issues/account/165/term/{termId}?subaccounts=true',
  'https://apac.udoit3.ciditools.com/api/admin/file_issues/account/165/term/{termId}?subaccounts=true',
  'https://apac.udoit3.ciditools.com/api/admin/file_actions/account/165/term/{termId}?subaccounts=true',
  'https://apac.udoit3.ciditools.com/api/admin/courses/account/165/term/{termId}?subaccounts=true' 
 ];
 ...
 // quizId = getQuizId(); 
      ...
      //try {
        if ( tokenId!=null ){
            if ($('#download-report').length === 0) {
                $('.css-e4i4eu-truncateList-appNav__list').append('<li class="css-166z3xu-truncateList__listItem"><button dir="ltr" id="raa-download-report" cursor="pointer" class="css-13npier-view--flex-item"><span class="css-1f9ldn1-item__label">Download RAA Reports</span></button></li>');
                
                $('#raa-download-report').one('click', {
                  type: 1
                }, RAAallReports);
            }
        }
  ...
  function RAAallReports(e) { //gets the student list
    pending = 0;
    fetched = 0;
    aborted = false;
    setupPool();
  ...
  function generateReports() {
    ...
    try {
      ...
      let savename = 'RAA UDOIT Reports' +'-' + today + '.xlsx';
